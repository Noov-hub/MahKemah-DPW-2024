            ...
            <div class="col-lg-3 col-md-6" style="margin-top:10px; margin-bottom:10px">
                <div class="card">
                    ...
                    <div class="card-body" >
                        ...
                        <a href="{{ route('bag_details', ['user_id' => auth()->user()->id, 'id' => $bag['id']]) }}" class="btn btn-secondary">detail</a>
                    </div>
                </div>
            </div>
        @endforeach
            ...
            <div class="col-lg-3 col-md-6" style="margin-top:10px; margin-bottom:10px">
                <div class="card">
                    ...
                    <div class="card-body" >
                        ...
                        <a href="{{ route('shoe_details', ['user_id' => auth()->user()->id, 'id' => $shoe['id']]) }}" class="btn btn-secondary">detail</a>
                    </div>
                </div>
            </div>
        @endforeach
            ...
            <div class="col-lg-3 col-md-6" style="margin-top:10px; margin-bottom:10px">
                <div class="card">
                    ...
                    <div class="card-body" >
                        ...
                        <a href="{{ route('tent_details', ['user_id' => auth()->user()->id, 'id' => $tent['id']]) }}" class="btn btn-secondary">detail</a>
                    </div>
                </div>
            </div>
        @endforeach
