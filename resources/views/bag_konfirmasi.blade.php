        ...
        <div class="member d-flex align-items-center">
            ...
            <div class="member-info">
                <div class="card-body">
                    ...
                    <form action="{{ route('konfirmasi_bag') }}" method="POST">
                        @csrf
                        <input type="hidden" name="bag_id" value="{{ $bag->id }}">
                        <input type="hidden" name="harga" value="{{ $bag['price'] }}">
                    ...
                    <a href="{{ route('bag_details', ['user_id' => auth()->user()->id, 'id' => $bag['id']]) }}" style="margin:5px">Kembali</a>
                </div>
            </div>
        </div>
    </div>
